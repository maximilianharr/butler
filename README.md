...
The core idea is to separate the backend from the frontend so that it can easily be accessed via a browser from anywhere without the necessity to build an app.
